...
import ExploreProductAreaTrans from "@containers/explore-product/layout-01/trans";
...
const trans = () => {
    ...
    const obtenerDatos = async () => {
        ...
        const data = await fetch(process.env.url + "perfil/getAnunciosTransAll")
