...
import ProcesarActivatPlanModal from "@components/modals/activar-plan-modal";

const POSTS_PER_PAGE = 300;

const TablaActivarPlanArea = ({ className, space, data }) => {
    ...
    const handleBidModal = async () => {
        ...
        const data6 = await fetch(process.env.url + "auth/getUsuariossinPlanActivo", requestOptionsPerfil)
    ...
    return (
        ...
        >
            <div className="container">
                ...
                <h6>Usuarios para Activar Plan</h6>
                <p>Solamente apareceran usuarios quienes no tengan activos planes como star o vip</p>
                </div>
                                ...
                                <tbody className="ranking">
                                    ...
                                    {results?.map((item, index) => (
                                        ...
                                        >
                                            ...
                                            <td>
                                                <p  onClick={(e) => setVal(item, e)} target="_blank"> <BsCalendarDate /></p>
                                            </td>
            ...
            <ProcesarActivatPlanModal  show={showBidModal} handleModal={handleBidModal} data={itemSelect}/>
        </div>
    
    );
};

TablaActivarPlanArea.propTypes = {
...
TablaActivarPlanArea.defaultProps = {
    space: 1,
};

export default TablaActivarPlanArea;
